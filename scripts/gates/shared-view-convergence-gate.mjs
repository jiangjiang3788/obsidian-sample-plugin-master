...
const requiredExtractionFiles = [
  ...
  ['src/features/settings/views/runtime/TaskExecutionViewModel.ts', 'Task execution model extracted in MVP15'],
  ['src/features/settings/views/runtime/TaskExecutionChipGrid.tsx', 'Task execution chip grid extracted in MVP15'],
...
const viewLineLimits = [
  ...
  ['src/features/settings/views/runtime/TaskExecutionView.tsx', 80, 'Task execution root should stay a state shell'],
