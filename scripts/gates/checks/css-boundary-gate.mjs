...
const requiredScopeMarkers = [
  ...
  ['src/app/dashboard/LayoutRenderer.tsx', 'think-os--layout'],
...
const v2Contracts = [
  ['src/shared/styles/muiTheme/index.ts', 'createThinkMuiTheme'],
  ['src/shared/styles/muiTheme/components.ts', 'var(--think-control-height-md'],
...
const v4Contracts = [
  ['src/features/views/runtime/ProgressGoalCard.tsx', 'think-progress-card'],
...
const v5Contracts = [
  ...
  ['src/features/views/runtime/components/items/TaskRow.tsx', 'task-row-title'],
  ['src/features/views/runtime/TableViewCell.tsx', 'think-table-cell-item'],
