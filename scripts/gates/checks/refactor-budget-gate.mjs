 ...
 *
 * Current maintenance budget keeps the converged surface from silently regressing:
 ...
 * and explicit any was reduced. The current budget preserves the explicit-any ceiling.
 */
