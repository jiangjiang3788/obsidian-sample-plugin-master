...
function check_task_domain_v2_gate() {
  ...
  requireText('src/core/types/cache.ts', 'CURRENT_CACHE_SCHEMA_VERSION = 14');
...
function check_no_task_line_runtime_gate() {
  ...
  if (!cache.includes('CURRENT_CACHE_SCHEMA_VERSION = 14')) failures.push('cache.ts: cache schema must be v14 after integrity persistence hardening');
