 ...
 * any-budget-gate
 *
 * Current type-governance locked budget. This gate does not ban every explicit any.
 * It makes the current debt visible, separates source/test/scripts counts, and
 * locks the current reduction floor so later passes cannot regress silently.
 */
