...
requireText('src/core/settings/ThinkSettings.ts', 'export const THINK_SETTINGS_SCHEMA_VERSION = 3');
...
console.log('[settings-schema] PASS (schemaVersion=3; current-only)');
