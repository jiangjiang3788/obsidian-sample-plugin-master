...
const requiredExtractionFiles = [
  ...
  ['src/features/views/runtime/ProgressViewModel.ts', 'Progress model extracted in MVP13'],
  ['src/features/views/runtime/ProgressGoalCard.tsx', 'Progress goal card extracted in MVP13'],
  ['src/features/views/runtime/TimelineView/TimelineViewModel.ts', 'Timeline render model extracted in MVP13'],
  ['src/features/views/runtime/TimelineView/TimelineDailyView.tsx', 'Timeline daily view extracted in MVP21'],
  ['src/features/views/runtime/TimelineView/TimelineDailyViewModel.ts', 'Timeline daily model extracted in MVP21'],
  ['src/features/views/runtime/EventTimelineView/EventTimelineViewModel.ts', 'Event timeline model extracted in MVP15'],
  ['src/features/views/runtime/EventTimelineView/EventTimelineEventList.tsx', 'Event timeline event list extracted in MVP15'],
  ['src/features/views/runtime/BlockViewModel.ts', 'Block view model extracted in MVP16'],
  ['src/features/views/runtime/BlockViewItemList.tsx', 'Block item list extracted in MVP16'],
  ['src/features/views/runtime/TableViewModel.ts', 'Table view model extracted in MVP16'],
  ['src/features/views/runtime/TableViewCell.tsx', 'Table view cell extracted in MVP16'],
  ['src/features/views/runtime/excel-view/ExcelViewModel.ts', 'Excel view model extracted in MVP14'],
  ['src/features/views/runtime/excel-view/ExcelViewToolbar.tsx', 'Excel toolbar extracted in MVP14'],
  ['src/features/views/runtime/excel-view/ExcelGridModel.ts', 'Excel grid model extracted in MVP17'],
  ['src/features/views/runtime/excel-view/ExcelCellModel.ts', 'Excel cell model extracted in MVP17'],
  ['src/features/views/runtime/excel-view/ExcelCellEditor.tsx', 'Excel cell editor extracted in MVP17'],
  ['src/features/views/runtime/excel-view/ExcelCellContent.tsx', 'Excel cell content extracted in MVP17'],
  ['src/features/views/runtime/excel-view/ExcelCellEditingModel.ts', 'Excel editing model extracted in MVP18'],
  ...
  ['src/features/views/runtime/ViewToolbarModel.ts', 'View toolbar model extracted in MVP19'],
];
...
const viewLineLimits = [
  ...
  ['src/features/views/runtime/TimelineView/TimelineViewView.tsx', 120, 'Timeline view should delegate daily rendering'],
  ['src/features/views/runtime/TimelineView/TimelineDailyView.tsx', 125, 'Timeline daily view should stay bounded'],
  ['src/features/views/runtime/EventTimelineView/EventTimelineViewContainer.tsx', 120, 'Event timeline container should stay a render-model shell'],
  ['src/features/views/runtime/EventTimelineView/EventTimelineViewView.tsx', 110, 'Event timeline view should delegate list rendering'],
  ['src/features/views/runtime/EventTimelineView/EventTimelineEventList.tsx', 120, 'Event list should stay bounded'],
  ['src/features/views/runtime/BlockView.tsx', 110, 'Block view should stay a grouped container shell'],
  ['src/features/views/runtime/TableView.tsx', 80, 'Table view should stay a table shell'],
  ['src/features/views/runtime/excel-view/ExcelView.tsx', 200, 'Excel root should stay a toolbar/grid shell'],
  ['src/features/views/runtime/excel-view/ExcelGrid.tsx', 200, 'Excel grid should delegate model-heavy interaction planning'],
  ['src/features/views/runtime/excel-view/ExcelCell.tsx', 180, 'Excel cell should delegate editor/content/model helpers'],
  ['src/features/views/runtime/excel-view/useExcelCellEditing.ts', 240, 'Excel editing hook should delegate planning helpers'],
  ['src/features/views/runtime/excel-view/ExcelColumnToolbar.tsx', 130, 'Excel column toolbar should delegate chip/menu/model helpers'],
  ['src/features/views/runtime/StatisticsView/StatisticsViewContainer.tsx', 190, 'Statistics container should stay a render-model shell'],
  ['src/features/views/runtime/StatisticsView/StatisticsViewView.tsx', 110, 'Statistics view should stay a period-view dispatcher'],
  ['src/features/views/runtime/StatisticsView/views/PeriodStatisticsView.tsx', 120, 'Shared month/quarter/year renderer should stay bounded'],
  ['src/features/views/runtime/ViewToolbar.tsx', 130, 'View toolbar should delegate date/filter options'],
];
...
const localRegressionChecks = [
  ...
  ['src/features/views/runtime/excel-view/ExcelColumnToolbar.tsx', ['function moveItem', 'interface ColumnMenuState', 'class="excel-column-context-menu"'], 'Excel column list/menu should stay delegated'],
  ['src/features/views/runtime/ViewToolbar.tsx', ['const viewOptions =', "'年': 'year'", 'formatDateForView('], 'View toolbar options/date math should stay in ViewToolbarModel'],
  ['src/features/views/runtime/StatisticsView/views/PeriodStatisticsView.tsx', ['getMonthWeeksData', 'aggregateByQuarter', 'createPeriodData'], 'Shared period renderer should keep math in period models'],
];
