// src/features/settings/views/runtime/StatisticsView/useStatisticsCategoryConfigs.ts
...
import type { CategoryColorMap, UpdateCategoryColorsHandler } from '@shared/types/public';
