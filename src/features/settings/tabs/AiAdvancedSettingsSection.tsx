    ...
    <>
      ...
      <ThinkDisclosure title="性能设置">
        <div className="think-settings-stack think-settings-stack--tight">
          ...
          <div className="think-settings-row"><span className="think-settings-row__label">缓存有效期（秒）</span><ThinkInput className="think-settings-field--md" type="number" value={settings.configCacheTTLSeconds} onInput={(e) => onUpdate({ configCacheTTLSeconds: parseInt((e.currentTarget as HTMLInputElement).value, 10) || 300 })} /></div>
        </div>
      </ThinkDisclosure>
    </>
  );
