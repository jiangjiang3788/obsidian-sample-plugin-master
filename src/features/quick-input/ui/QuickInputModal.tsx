...
// [修改] Button, FormControl, Typography等依然保留，只移除TextField
import { Button, RadioGroup as MuiRadioGroup, FormControlLabel, Radio, FormControl, Typography, Stack, Divider } from '@mui/material';
...
    if (DEBUG_MODE) console.log(`%c[QuickInputForm] 快捷输入面板渲染。Block: ${blockId}`, 'color: blue; font-weight: bold;');
...
    };
    ...
    // [核心修复] 重写 renderField 函数，用原生组件替换 MUI TextField
...
            default: {
    ...
    const commonInputProps = {
        className: 'think-native-input', // 添加一个class方便样式调整
        value: value || '',
    ...
    // 日志调试：只在渲染 input 元素时打印
    if (field.type !== 'textarea') {
        console.log("Rendering input with props:", {
            ...commonInputProps,
