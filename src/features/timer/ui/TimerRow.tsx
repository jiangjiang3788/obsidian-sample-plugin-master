...
// [新增] 导入 QuickInputModal 以修复 handleEdit 功能
import { QuickInputModal } from '@features/quick-input/ui/QuickInputModal';
// [新增] 导入 appStore 以便传递给 QuickInputModal
...
            if (config) {
                // [修复] 正确调用 QuickInputModal，并传入所需的 store 实例
                new QuickInputModal(app, config.blockId, config.context, undefined, undefined, dataStore, appStore).open();
            }
        }
    };
