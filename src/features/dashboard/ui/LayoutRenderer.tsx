...
import { Layout, readField } from '@core/domain/schema';
...
export function LayoutRenderer({ layout, dataStore, plugin }: Props) { // [MODIFIED] 增加 plugin 析构
...
    const viewProps: any = {
      app: plugin.app, // [MODIFIED] 传递 app 实例
      items: viewItems,
      dateRange: dateRange,
      module: viewInstance, 
