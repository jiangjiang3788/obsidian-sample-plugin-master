...
export function resolveTimelineConfig(module: any, injectedModel?: Partial<TimelineRenderModel>): any {
...
export function buildTimelineColorMap(config: any, injectedModel?: Partial<TimelineRenderModel>): Record<string, string> {
