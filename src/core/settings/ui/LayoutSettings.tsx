...
        AppStore.instance.duplicateLayout(id);
    };

    const handleMove = (id: string, direction: 'up' | 'down') => {
        AppStore.instance.moveLayout(id, direction);
    };
...
                                <Tooltip title="上移">
                                    <span>
                                        <IconButton size="small" sx={{ fontSize: '1.2em' }} disabled={index === 0} onClick={e => { e.stopPropagation(); handleMove(l.id, 'up'); }}>
                                            ▲
                                        </IconButton>
                                    </span>
                                </Tooltip>
                                <Tooltip title="下移">
                                    <span>
                                        <IconButton size="small" sx={{ fontSize: '1.2em' }} disabled={index === layouts.length - 1} onClick={e => { e.stopPropagation(); handleMove(l.id, 'down'); }}>
                                            ▼
                                        </IconButton>
                                    </span>
                                </Tooltip>
                                <Tooltip title="复制此布局">
                                    <IconButton size="small" onClick={e => { e.stopPropagation(); handleDuplicate(l.id); }}>
